        ...
        <section className="alert-section top-50">
          <div className="container">
            ...
            <div className="alert-text">
              "ServeU and facilities management solutions, to supply everything
              you need for a safe, clean and productive working environment.
              ServeU prides itself in understanding a complex maintenance
              industry. From our extensive hard and soft services to cleaning
              services, we are your one source for comprehensive facility
              management services and cost savings.” ABOUT US
              <br />
