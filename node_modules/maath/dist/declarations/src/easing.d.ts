 ...
 */
export declare function damp(current: {
    [key: string]: any;
...
export declare function dampE(current: Euler, target: [x: number, y: number, z: number, order?: string] | Euler, smoothTime: number, delta: number, maxSpeed: number, easing?: (t: number) => number, eps?: number): boolean;
